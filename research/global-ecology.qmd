...
![*Cosmic Thing*, Damian Ortega (2002)](/static/ortgega-cosmic-thing.jpeg){fig-alt="A Volkswagon Beetle car disassembled into parts that are suspended by wire from the ceiling and arranged to be near their adjacent parts when the car was assembled." fig-align="center" width="8in"}
...
See our [blog](https://compadredb.wordpress.com/) for highlights of recent papers that have resulted from this effort, or [download the latest versions of each dataset](http://www.compadre-db.org/Data).
...
![Plasticine dummy caterpillar in Zackenberg, Greenland. Photo: T. Roslin](/static/zackenberg-dummy-caterpillar.jpeg){fig-alt="A green-grey plasticine model of a geometrid caterpillar on low-growing vegetation with a mountain in the background." fig-align="center" width="6in"}
...
![*Plantago lanceolata* demography and leaf-level physiology at Norris Ranch Marino Reserve. (L to R: Greg Vose, Emily Griffoul)](/static/plantago-norris-ranch-marino.JPG){fig-alt="Two people collecting demographic census data and photosynthesis rates with a LiCor infrared gas analyzer in a coastal grassland." fig-align="center" width="6in"}
