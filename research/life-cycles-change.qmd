# Persistence of complex life cycles under rapid environmental change

![*La teoría de un rumor*, Ulises Carrión (1978)](/static/carrion-la-teoria-de-un-rumor.jpeg){fig-alt="A grid of framed drawings, each with arrows pointing in various directions." fig-align="center" width="8in"}
...
![](/static/logo-nsf.jpg){fig-alt="Logo of the National Science Foundation" fig-align="center" width="0.75in"}

![*Valeriana edulis* growing at its current upper elevation range limit (3790 m).](/static/valeriana-frigid-air.jpg){fig-alt="A plant rosette growing on a high mountain ridge." fig-align="center" width="3.75in"}
...
![David Inouye (L) and Jake Davis (R) conducting the 53rd annual *Frasera speciosa* census. One individual has produced a column of flowers in it's final swan song after decades of vegetative growth.](/static/frasera-cumberland-pass.jpg){fig-alt="Two people collecting data in an alpine meadow divided into a 1x1m grid of plots by white string." fig-align="center" width="3.75in"}
...
The seed funds for this work came from the Myrna Steinkamp Grant for research on rare plants from the [Colorado Native Plant Society](https://conps.org/).

![](/static/logo-conps.png){fig-alt="Logo of the Colorado Native Plant Society" fig-align="center" width="1.25in"}

![An individual *Physaria alpina* moments before being imaged by the drone launching in the background.](/static/physaria-drone-launch.jpeg){fig-alt="A small plant with silvery-green leaves and bright yellow flowers growing on a rocky alpine ridge." fig-align="center" width="6in"}
