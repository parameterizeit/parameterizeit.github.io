...
![Ryerse Lake, upper peninsula of Michigan.](static/ryerse_lake.jpeg){fig-alt="A panoramic photo of a lake with a floating island of spaghnum with a conifer tree growing on it." fig-align="center" width="8in"}
...
```{=html}
<!--# ::: callout-note
## For the Fall 2026 admission cycle, we are only able to consider applicants who would bring fellowship funding to support their tuition, fees, and stipend for the initial few years. Please make sure to highlight the fellowships you're eligible for, and ideas for your application when you contact us.
::: -->
```

::: callout-note
## The 2026-27 academic year admission cycle has closed. The 2027-28 academic year admission cycle begins in late summer/early fall with applications due between December 2026-January 2027. *(March 2026)*
:::

Prospective graduate students who want to do ecological research on questions related to biodiversity in changing environments should [email Dr. Petry](people/petry-w/about.qmd) in the late summer or early fall (July-October) with the following pieces of information:
...
- Indicate whether you have applied or would like to work together on a fellowship application (e.g., [NSF GRFP](https://www.nsfgrfp.org/) or [one of many other fellowships](https://www.pathwaystoscience.org/Grad.aspx)).

- Your current CV (see advice [at Word Vice](https://wordvice.com/how-to-write-a-flawless-cv-curriculum-vitae-for-graduate-school/) and [Prep Scholar](https://www.prepscholar.com/gre/blog/how-to-write-a-cv-for-graduate-school/) on how to prepare an effective CV).
...
::: callout-note
## There are no funded postdoc opportunities at this time. Please contact us if you're interested to pursue a postdoctoral fellowship. *(March 2026)*
:::
...
- **Advertised positions:** these are usually funded through an existing grant and will be announced broadly via ECOLOG, social media, and similar venues ([why we advertise](https://www.chronicle.com/article/how-the-opaque-way-we-hire-postdocs-contributes-to-sciences-diversity-problem/))

- **Fellowships:** these are initiated by the prospective postdoc, based on a collaboratively-developed application to a specific fellowship competition (several lists of eco/evo postdoc fellowships are available, e.g., [Biology Postdocs](http://biologypostdocs.weebly.com/north-america.html), [UC Davis list](http://www.des.ucdavis.edu/faculty/baskett/links/academia.html#Postdoc), & [public spreadsheet](https://docs.google.com/spreadsheets/d/1cHkWrbvNrRdhJL9Z8ucgBZ2HSts2GPA_yozbQPl_x_8/edit#gid=0))
...
::: callout-note
## There are no open undergraduate research opportunities at this time. *(March 2026)*
:::
...
::: callout-note
## There are no seasonal field technician opportunities at this time. *(March 2026)*
:::
